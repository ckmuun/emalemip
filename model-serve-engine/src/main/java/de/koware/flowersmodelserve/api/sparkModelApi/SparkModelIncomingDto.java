...
public class SparkModelIncomingDto extends BaseIncomingDto {


    private static final Logger LOGGER = LoggerFactory.getLogger(SparkModelIncomingDto.class);
    ...
    @JsonCreator
    private SparkModelIncomingDto() {
        super();
    }

    public SparkModelIncomingDto(
    ...
    public SparkModelContainer getSparkModelContainer() {
        LOGGER.info("creating spark model container from stored fields");
